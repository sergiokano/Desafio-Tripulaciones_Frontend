...
import { FaExclamationCircle, FaRegUserCircle, FaUser, FaUserCircle } from "react-icons/fa";
...
const RegisterNeighbour = () => {
  ...
  return (
    <div className="flex-1 flex flex-col">
      <form className="flex-1 flex flex-col items-center" onSubmit={onSubmit}>
          ...
          >
            <div className="flex items-center">
              <div className="mr-2">
                ...
                {errorIcon === "checked" && <FaExclamationCircle />}
        ...
        <div className="w-5/6">
          <button
            type="submit"
            className="text-white text-[17px] w-full my-8 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-[12px] p-2.5"
          >
            Registrarse
          </button>
        </div>
